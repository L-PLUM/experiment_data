...
contract SolidityVisibility1 {
   ...
   // <yes> <report> solidity_implicit_visibility vis104
    uint x;
    uint private y;

   // <yes> <report> solidity_implicit_visibility vis102
    function transfer() {
        x=0;
    }
  ...
  // <yes> <report> solidity_implicit_visibility vis103
    function () private {
    }
}
...
contract SolidityVisibility2 {
   ...
   // <yes> <report> solidity_implicit_visibility vis105
...
interface SolidityVisibility3 {
   ...
   // <yes> <report> solidity_implicit_visibility vis101
