...
contract UpgradeTo050_1 {
    // <yes> <report> solidity_upgrade_code_format upg104
    function call(address token, bytes memory a, bytes b) public {
        // <yes> <report> solidity_upgrade_code_format upg101
        address(token).call();
        // <yes> <report> solidity_upgrade_code_format upg101
        token.call();
        // <yes> <report> solidity_upgrade_code_format upg101
        ...
        // <yes> <report> solidity_upgrade_code_format upg102
        bytes32 ab = keccak256(a, b);
        ab = keccak256(abi.encodePacked(a, b));
    }
    // <yes> <report> solidity_upgrade_code_format upg103
    function () private {
    }
}
...
contract UpgradeTo050_3 {
    ...
    function numberOne() external{
        // <yes> <report> solidity_upgrade_code_format upg105
        uint[] a;
