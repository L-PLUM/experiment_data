...
contract SimpleMultiSigWallet is multiowned {
    ...
    function sendEther(address payable to, uint value)
        public
        onlymanyowners(keccak256(msg.data))
    {
...
result[0] = address(0x2263BfCAD3D4eB2EaC76a323998f512FD35256Bd);
result[1] = address(0xCC8Ec3419B5a273Af965bc144030c026bC4cB4a3);
        return result;
    }
