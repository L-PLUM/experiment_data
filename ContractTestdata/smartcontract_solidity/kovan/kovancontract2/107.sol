...
contract NewVoken is Ownable, Pausable, IERC20 {
    ...
    function transfer(address recipient, uint256 amount) external whenNotPaused returns (bool) {
        ...
        // Burn
        else if (recipient == address(0) || recipient == address(0xdead)) {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (_rejectNonWhitelistTransaction && sender != address(this) && recipient != address(this)) {
