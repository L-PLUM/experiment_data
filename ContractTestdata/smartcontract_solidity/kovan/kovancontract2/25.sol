...
// File: contracts\release\ownership\Ownable.sol
...
contract Lockable is Ownable {
    ...
    function isAccountLocked(address account) private returns (bool) {
    ...
    function unlockToken() public onlyOwner {
		_tokenLocked = false; // not need to confirm _tokenLocked = true
        emit TokenUnlocked();
	}
...
contract MediumToken is ERC20Detailed, ERC20Burnable, ERC20Lockable {
    constructor()
    ERC20Detailed("Medium Token Kovan_1", "kMDM", 18)
    public
    {
