...
contract BcnxDistribution {
    ...
    event NewTimeLock(address addr, BcnxToken token, uint256 lock_end);

    BcnxToken public token;
    uint256 private constant TEAM_TOKENS = 76 * (10 ** 6) * (10 ** uint256(18));
    uint256 [] public LOCK_END = [
        1564406854, // Tue, 31 Dec 2019 00:00:00 GMT
        1564407004, // Thu, 31 Dec 2020 00:00:00 GMT
    ...
    constructor () public {
        ...
        for (uint i = 0; i < LOCK_END.length; i++) {
            ...
            emit NewTimeLock(address(timelock), token, releaseTime);
        }
