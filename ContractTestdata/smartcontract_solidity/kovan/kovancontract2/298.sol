...
/// @title BlockchainCuties: Collectible and breedable cuties on the Ethereum blockchain.
/// @author https://BlockChainArchitect.io
contract ERC721UriProvider is Operators, UriProviderInterface
{
    string public metadataUrlPrefix = "https://blockchaincuties.com/token/";
    ...
    function setMetadataUrl(string _metadataUrlPrefix, string _metadataUrlSuffix) external onlyOwner
    {
    ...
    function uintToString(uint256 a) internal pure returns (string memory result)
    {
        string memory r = "";
        do
        {
