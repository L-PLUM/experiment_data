...
//    TokenVesting vault = new TokenVesting(msg.sender, AMOUNT_PER_RELEASE, LOCK_END, false);
//    _mint(address(vault), TEAM_TOKENS);
  }
...
contract BcnxDistribution {
    ...
    //      1576368000, // Sun, 15 Dec 2019 00:00:00 GMT
    //      1607990400, // Tue, 15 Dec 2020 00:00:00 GMT
    //      1639526400, // Wed, 15 Dec 2021 00:00:00 GMT
    //      1671062400  // Thu, 15 Dec 2022 00:00:00 GMT
    1564043100,
    1564043400,
    1564043700,
    1564044000
    ...
    constructor () public {
        ...
        for (uint i = 0; i < LOCK_END.length; i++) {
            TokenTimelock timelock = new TokenTimelock(token, msg.sender, LOCK_END[i]);
            token.transfer(address(timelock), AMOUNT_PER_RELEASE);
        }
        
        uint256 totalSupply = token.totalSupply();
        uint256 remainingBalance = totalSupply.sub(TEAM_TOKENS);
