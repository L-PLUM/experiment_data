...
contract MarketPlace is Pausable, Ownable {
    ...
    */
    ...
    mapping(uint256 => address) public storeToOwners;
    ...
    mapping(uint256 => uint256[]) storeToProducts;
    ...
    */
    function purchaseProduct(uint256 productID, address tokenAddress, uint256 paidAmount, uint256 quantity) public payable {
        ...
        if(tokenAddress == address(0)) {
            require(msg.value >= totalCost, "Not eligible to purchase the products");
            ...
            balances[product.storeID][tokenAddress] = balances[product.storeID][tokenAddress].add(paidAmount);
        }
