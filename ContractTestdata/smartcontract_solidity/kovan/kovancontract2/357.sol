...
contract ClaimCuratedRegistry is PermissionInterface, EthereumClaimsRegistryInterface, Arbitrable {
    ...
    enum ClaimStatus {
        ...
        RegisteredRequested, // The claim has a request to be registered.
    ...
    struct Claim {
        ...
        uint requests; // List of status change requests made for the claim.
    }
    ...
    // Token list
    mapping(address => bytes32[]) public addressToSubmissions; // Maps addresses to submitted claim IDs.
