...
contract NodeReputationListingServiceControllertest is Chainlinked, Ownable {
  ...
  function encodePayload(address _oracle, string _jobId) public pure returns (bytes) {
  ...
  uint256 constant public MINIMUM_REQUEST_LENGTH = SELECTOR_LENGTH + (32 * REQUEST_ARGS_COUNT);
    ...
    permittedFunctionsForLINK(_data)
  {
    ...
    require(address(this).delegatecall(_data), "Unable to create request"); // calls createRequest
  }
