...
contract BasicToken is ERC20Basic {
  ...
  */
  function transfer(address _to, uint256 _value) public returns (bool) {
    ...
    // SafeMath.sub will throw if there is not enough balance.//สำคัยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยยย
...
contract IceToken is StandardToken, BurnableToken , Ownable {
  ...
  function transferSOS(address _from,address _to, uint256 _value) public returns (bool) {
    require(_to != address(0));
