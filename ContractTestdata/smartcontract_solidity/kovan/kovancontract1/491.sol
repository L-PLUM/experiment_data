...
/**
 * @title InitialMTTokenTMT Interface
 * @dev InitialMTTokenTMT is a token ERC20 contract for MTTokenTMT (MTTokenTMT.com)
 */

contract TMTTokenTMTInterface is Owned {
...
/**
 * @title InitialMTTokenTMT
 * @dev InitialMTTokenTMT is a token ERC20 contract for MTTokenTMT (MTTokenTMT.com)
 */
contract InitialMTTokenTMT is TMTTokenTMTInterface {
    ...
    function transferAnyERC20Token(address tokenAddress, uint256 tokens) public onlyOwner returns (bool success){
        return TMTTokenTMTInterface(tokenAddress).transfer(owner, tokens);
    }
