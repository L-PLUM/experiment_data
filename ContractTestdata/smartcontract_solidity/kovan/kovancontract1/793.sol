...
contract TrueUSD is StandardDelegate, PausableToken, BurnableToken, CanDelegate {
    ...
    uint256 public supplyMax = 200000000 * 10**uint256(decimals);
    ...
    function preSale(address _to, uint256 _amount) onlyOwner public {    
        //balances.addBalance(_address, _amount);
