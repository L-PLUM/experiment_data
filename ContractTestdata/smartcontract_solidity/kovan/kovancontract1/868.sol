...
////////////////
    ...
    public
    {
        ...
        require(ERC20(_dividendToken).transferFrom(msg.sender, this, _amount), "transferFrom");
...
/** @title Dividend AssetToken. Inherits Basic functionality, clearing calls and extends Dividend functionality. */
