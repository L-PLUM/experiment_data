...
contract Schema is ISchema, Ownable, SupportsInterfaceWithLookup {
    ...
    bool[2] private uniqValidationStatus = [false,false];
...
none: uint256(0) 
        ...
        returns (string, uint256)
    {
        ...
        return (
            entries[entryIndex].ver,
entries[entryIndex].none
        );
    }
...
none: _none
        ...
        emit EntryUpdated(_entryID, _ver, _none);
    }
