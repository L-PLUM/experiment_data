...
contract SampleToken is StandardToken, Ownable {
    ...
    modifier checktimelock() {
        require(now >= timeLock || ingnoreLocks[msg.sender]);
        _;
    }
    
    function SampleToken(uint time_lock, address crowdsale_contract, string _name, string _symbol, uint supply) public {
