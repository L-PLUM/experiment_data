...
contract InvestmentPlatform is Ownable {
    ...
    uint256 public requirement = 400000 * 10**uint256(18);
    ...
    */
    function invest(uint256 amount) external onlyInvestor whenNotPaused returns (bool) {
    ...
    */
    function completeproject() external onlyAdmin whenNotPaused {
        ...
        emit CompleteProject(msg.sender,totalfunds);
    }
    ...
    */
    function cashout() external onlyInvestor whenNotPaused {
        ...
        totalfunds = totalfunds.sub(balances[msg.sender]);
