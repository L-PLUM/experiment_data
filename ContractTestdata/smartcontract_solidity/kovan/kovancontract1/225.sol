...
contract Arbitrable {
    ...
    function raiseDispute(Arbitrator _arbitrator, uint _choices, bytes _extraData, uint _metaEvidenceID) public payable {
        uint disputeID = _arbitrator.createDispute.value(msg.value)(_choices, _extraData);
        emit Dispute(_arbitrator, disputeID, _metaEvidenceID);
    }
}
