...
contract RightMeshContestTokenPaymentChannel is Ownable {
    ...
    mapping (bytes32 => ClosingRequest) private closingRequests;
    ...
    external
    view
    returns (bytes32, uint192, uint192, uint32, uint192, uint32) {
        ...
        return (
            ...
            closingRequests[key].claimAmountPaid,
            closingRequests[key].earliestSettlementBlockNumber
        );
    }
