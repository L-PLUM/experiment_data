...
///////////////////
    ...
    /// @notice Set mint control role. Usually this is CONDA's clearing.
...
// File: contracts/assettoken/interfaces/ICRWDClearing.sol
...
interface IGlobalIndex {
    function getClearingAddress() external view returns (address);
    function setClearingAddress(address _newClearingAddress) external;
}
...
/** @title CRWD AssetToken. This contract inherits basic functionality and extends calls to clearing. */
contract CRWDAssetToken is BasicAssetToken, ICRWDAssetToken {
    ...
    function getClearingAddress() public view returns (address) {
        return globalIndex.getClearingAddress();
    }
    ...
    /** @dev ERC20 transfer function overlay to transfer tokens and do clearing.
      ...
      */
    function transfer(address _to, uint256 _amount) public returns (bool success) {
        ICRWDClearing(getClearingAddress()).transferParticipantsVerification(baseCurrency, msg.sender, _to, _amount);
    ...
    /** @dev ERC20 transferFrom function overlay to transfer tokens and do clearing.
      ...
      */
    function transferFrom(address _from, address _to, uint256 _amount) public returns (bool success) {
        ICRWDClearing(getClearingAddress()).transferParticipantsVerification(baseCurrency, _from, _to, _amount);
    ...
    /** @dev Set clearing address that receives clearing.
      * @param _globalIndexAddress Address to be used for clearing.
      */
...
// File: contracts/assettoken/STOs/BlockpitTaxToken.sol

/** @title Blockpit Tax Token. A CRWDAssetToken with CapitalControl and LostWallet feature */
contract BlockpitTaxToken is CRWDAssetToken, FeatureCapitalControlWithForcedTransferFrom
{    
