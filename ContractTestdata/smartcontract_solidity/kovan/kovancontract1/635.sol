...
contract Blueprint is Ownable {
    ...
    function createExchange(string _id,string _exchange, string _security, uint256 _entry, uint256 _exit, uint256 _expires) public onlyOwner
  ...
  */
  function getBluePrint(string _id) public view returns (string,string,uint256,uint256,uint256,uint256) {
