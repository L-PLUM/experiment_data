...
contract SmartSnake{
    ...
    function checkWeek() private{
        ...
        require(_week >= week, "We should only go forward in time");
    ...
    function isReferal(address referrerAddr) private returns (bool) {
       return investorsStorage[referrerAddr].balance > 0;
    }
