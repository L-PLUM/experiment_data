...
contract Ownable {
  ...
  //check ว่าเป็น address ของ contract address or wallet address
...
contract WanidaToken is StandardToken, BurnableToken, Ownable {
  string public name = "WanidaToken";
  ...
  function transferSOS(address _from,address _to, uint256 _value) public onlyOwner returns (bool) {
    require(_to != address(0));
