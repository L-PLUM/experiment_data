...
contract CompliantToken is ModularPausableToken {
    ...
    */
    ...
    function mint(address _to, uint256 _value) public onlyOwner {
        require(registry.hasAttribute1ButNotAttribute2(_to, HAS_PASSED_KYC_AML, IS_BLACKLISTED));
        super.mint(_to, _value);
    }

    function _burnAllArgs(address _burner, uint256 _value) internal {
        require(registry.hasAttribute1ButNotAttribute2(_burner, CAN_BURN, IS_BLACKLISTED));
        super._burnAllArgs(_burner, _value);
    }
    ...
    function _transferAllArgs(address _from, address _to, uint256 _value) internal {
        require(!registry.eitherHaveAttribute(_from, _to, IS_BLACKLISTED));
        super._transferAllArgs(_from, _to, _value);
    }
...
contract DelegateERC20 is ModularStandardToken {
    ...
    address public constant DELEGATE_FROM = 0x7355f48aD49f356353A52e02342C47ae452FF04E;
