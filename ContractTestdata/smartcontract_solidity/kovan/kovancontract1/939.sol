...
contract IoTrustERC20 is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function IoTrustERC20() {
        ...
        name = "IoTrustERC20";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "IOTE";                                             // Set the symbol for display purposes (CHANGE THIS)
