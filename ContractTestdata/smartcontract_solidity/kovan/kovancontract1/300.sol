 ...
 */
contract TestTokenForWIMS is Manager, ERC20
{
    /**
     * @notice function constructor for the WIMT contract
     */
     
    function TestTokenForWIMS(uint256 _totalSupply, string _name, string _symbol, uint8 _decimal ) public  ERC20(_totalSupply, _name, _symbol, _decimal)
	{
