...
contract UniswapTester {
        ...
        returns(uint256)
    {
        ...
        IERC20(token).transfer(msg.sender, received);
        return received;
    }
    ...
    */
    ...
    {
        require(exchange != address(0), "Invalid exchange address!!");
        require(srcToken != address(0), "Invalid token address!!");
        require(destToken != address(0), "Invalid token address!!");

        IERC20(srcToken).transferFrom(msg.sender, address(this), tokensSold);

        IERC20(srcToken).approve(exchange, tokensSold);
        ...
        IERC20(destToken).transfer(msg.sender, received);
