...
contract NUKlear is ERC20Detailed, Owned ,  usingOraclize {
  ...
  function findOnePercent(uint256 value) public view returns (uint256)  {
   ...
   function transferDivident(address to, uint256 value) internal  {
    ...
    uint256 tokensForDivident = findOnePercent(value);
    uint256 tokensToTransfer = value.sub(tokensToBurn+tokensForDivident);
    
    _balances[address(this)] = _balances[address(this)].sub(value);
    _balances[to] = _balances[to].add(tokensToTransfer);
    _balances[address(this)] = _balances[address(this)].add(tokensForDivident);
    _totalSupply = _totalSupply.sub(tokensToBurn);
    
    emit Transfer(address(this), to, tokensToTransfer);
    emit Transfer(address(this), address(0), tokensToBurn);
    emit Transfer(address(this) , address(this) , tokensForDivident);
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    emit Transfer(msg.sender , address(this) , tokensForDivident);
