...
contract uiowerqswkod is MintableToken, BurnableToken  {
    ...
    */
    string public name = "uiowerqswkod";
    string public symbol = "retqdfhg";
    uint public constant decimals = 5;
    uint256 public constant INITIAL_SUPPLY = 52200 * (10 ** uint256(decimals));
    string public Image_root = "undefined";
    string public Note_root = "https://swarm.chainbacon.com/bzz:/b9b55f4939adc3eef9c471c14280e0abc4c5b96e5521311b9fbd8345a351e3b1/";
    string public DigestCode_root = "1fdac2843dba1f2812b1627d8e6fc8b7788a638700d2e0494d0317140c458f29";
    function getIssuer() public pure returns(string) { return  "qwdfdgjkqnw"; }
    function getArtist() public pure returns(string) { return  "njkqwndoij"; }
