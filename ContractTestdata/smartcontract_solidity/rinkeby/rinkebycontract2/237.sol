...
contract AugustusSwapper is ReentrancyGuard, Ownable {
        ...
        nonReentrant
    {
        ...
        for (uint256 i = 0; i < callees.length; i++) {
            ...
            (bool result, uint256 tempReceivedAmount) = externalCall(
            ...
            receivedAmount = receivedAmount.add(tempReceivedAmount);
        }
        ...
        returns (bool, uint256)
    {
        ...
        assembly {
            ...
            result := call(
                ...
                x,
                0x20                  // Output is ignored, therefore the output size is zero
            )
            received := mload(x)
        }
