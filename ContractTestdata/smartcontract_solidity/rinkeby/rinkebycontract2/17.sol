...
contract bacon is MintableToken, BurnableToken  {
    ...
    */
    ...
    uint256 public constant INITIAL_SUPPLY = 771 * (10 ** uint256(decimals));
    string public Image_root = "https://swarm.chainbacon.com/bzz:/f2e274dbc6149e7e8de083639f551705bb826a45c405576b2cc1086f1e692fe1/";
    string public Note_root = "https://swarm.chainbacon.com/bzz:/d9dc6bb31b045521ffd02615a5ac6ceca015037e3e229527deed1efc4e1a5f64/";
    string public DigestCode_root = "576f7bd8cceda5eb79544e54ce85d21e7eaf484ef5c328027a3fddaaaad1843c";
    function getIssuer() public pure returns(string) { return  "pig"; }
    function getSource() public pure returns(string) { return  "someone"; }
