...
contract CertificationRegistry {
    ...
    */
    ...
    /**
      ...
      * @param _ExpiresDate Timestamp (Unix epoch) when the certificate will expire.
      * @param _Scope The scope of the certificate.
      * @param _CertificateBodyName The issuer of the certificate.
      */
    function setOrganizationCertificate(
        ...
        string memory _ExpiresDate,
        string memory _Scope,
        string memory _CertificateBodyName
    )
    public
    onlyRosenCertAdmin
    {
