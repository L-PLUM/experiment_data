...
contract doesTransfers is Ownable, Events {
    ...
    function setTransferFalse() public onlyOwner {
        transferON = false;
    }
    function setTransferTrue() public onlyOwner {
        transferON = true;
    }
...
contract doesSending is Ownable, Events {
    ...
    function setSendFalse() public onlyOwner {
        sendON = false;
    }
    function setSendTrue() public onlyOwner {
        sendON = true;
    }
