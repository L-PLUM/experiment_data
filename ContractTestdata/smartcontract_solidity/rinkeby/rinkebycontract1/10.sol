...
contract Operator {
    ...
    uint256 public MIN_DEP = 10 ether;
    ...
    function depositProcess(address sender) internal {
        ...
        require(msg.value >= investor.minDeposit);
    ...
    function setEnv(uint256 _maxLevelsAddSale, uint256 _ONE_DAY, uint256 _MAX_DEP) public {
