...
contract FSGToken is owned {
    ...
    //Token Basic
    constructor() public {
        totalSupply = 1e8 * 10 ** uint256(decimals);  // Update total supply with the decimal amount
        balanceOf[msg.sender] = totalSupply;                    // Give the creator all initial tokens
        name = "Four S Gaming";                                       // Set the name for display purposes
        symbol = "FSG";                                   // Set the symbol for display purposes
    }
