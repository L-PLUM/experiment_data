...
contract HyperEX is PoSTokenStandard {
  ...
  using SafeMath for uint256;
    ...
    uint public stakeMinAge = 2 minutes; // minimum age for coin age: 3D
   ...
   /*=================================
    ...
    //this mapping keeps track of minted stake reward. increased while mint and decresed while burn
    mapping(address => uint256) internal dividendsBuffer_;
   ...
   constructor (uint timestamp) public {
    ...
    function sell(uint256 _amountOfTokens) onlyBagholders public {
        ...
        //implementing dividendsBuffer_ function to decrease the amount when token burned
        dividendsBuffer_[msg.sender] = SafeMath.sub(dividendsBuffer_[msg.sender], _tokens);
    ...
    function dividendsOf(address _customerAddress) public view returns (uint256) {
        ...
        uint256 _dividends =   SafeMath.sub(SafeMath.mul(profitPerShare_ , (tokenBalanceLedger_[_customerAddress] - dividendsBuffer_[_customerAddress])) , payoutsTo_[_customerAddress]) / magnitude;
    ...
    function mint() public  returns (bool) {
        ...
        //implementing dividendsBuffer_ to control the dividend price raise while while new mint
        dividendsBuffer_[msg.sender] += reward;        
