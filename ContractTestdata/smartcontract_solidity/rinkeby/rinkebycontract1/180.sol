...
contract SafiToken is ERC20Interface{
    string public name = "Safi";
...
contract SafiICO is SafiToken{
    ...
    //token price in wei: 1CRPT = 0.001 ETHER, 1 ETHER = 1000 SAFI
    ...
    uint public coinTradeStart = now; //transferable in a week after salesEnd
