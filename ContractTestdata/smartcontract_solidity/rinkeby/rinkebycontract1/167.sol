...
contract Booking is Ownable {
    ...
    function Booking() public payable {
        ...
        m_address = 'qqqqqqqqqqqqqqq';
        m_description = 'qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq';
        m_fileUrl = 'javascript: alert(1)';
        m_fileHash = 0;
        m_price = 0.000001 ether;
        m_cancellationFee = 0.00000001 ether;
        m_rentDateStart = 1534971600;
        m_rentDateEnd = 1535749200;
        m_noCancelPeriod = 1;
