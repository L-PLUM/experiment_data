...
// ----------------------------------------------------------------------------
    ...
    contract TokenERC20 {
        ...
        using SafeMath for uint256;
    	string public name = "MICA TOKEN";
        string public symbol = "MICA";
        uint8 public decimals = 18;         // 18 decimals is the strongly suggested default, avoid changing it
        uint256 public totalSupply          = 56000000000 * (1 ether);   
		...
		address public teamWallet = 0x2ee1B3a716d140eA5a46F37C7FC944B41Ab0ACBa;
    ...
    contract MICA is owned, TokenERC20 {
