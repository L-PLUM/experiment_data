...
contract MultiSigRoot is Label {
    ...
    event WalletAttached(address indexed wallet);
    event WalletDetached(address indexed wallet);
...
contract MultiSigRegulator is Label {
    ...
    bytes32 private LABEL_CODE_BACKSYS = encodePacked("BACKSYS");
    bytes32 private LABEL_CODE_OPS = encodePacked("OPS");
    ...
    /**
     * Supported non-payable function: ERC20.increaseSupply
     */
    ...
    /**
     * Supported non-payable function: ERC20.decreaseSupply
     */
    ...
    /**
     * Supported non-payable function: ERC20.transfer
     */
    function transfer(address /* _to */, uint256 _value) external
        onlyMe
        onlySealed
    {
        defaultRequirement("transfer", _value);
    }

    /**
     * Supported non-payable function: ERC20.transferFrom
     */
    function transferFrom(address /* _from */, address /* _to */, uint256 _value) external
        onlyMe
        onlySealed
    {
        defaultRequirement("transferFrom", _value);
    }

    /**
     * Supported non-payable function: ERC20.approve
     */
    function approve(address /* _spender */, uint256 _value) external
        onlyMe
        onlySealed
    {
        defaultRequirement("approve", _value);
    }

    /**
     * Supported non-payable function: ERC20.increaseApproval
     */
    function increaseApproval(address /* _spender */, uint256 _addedValue) external
        onlyMe
        onlySealed
    {
        defaultRequirement("increaseApproval", _addedValue);
    }

    /**
     * Supported non-payable function: ERC20.decreaseApproval
     */
    function decreaseApproval(address /* _spender */, uint256 _subtractedValue) external
        onlyMe
        onlySealed
    {
        defaultRequirement("decreaseApproval", _subtractedValue);
    }

    /**
     * Supported non-payable function: ERC20.approveAndCall
     */
    function approveAndCall(address /* _spender */, uint256 _value, bytes calldata /* _extraData */) external
        onlyMe
        onlySealed
    {
        defaultRequirement("approveAndCall", _value);
    }

    /**
     * Supported non-payable function: ERC20.freeze
     */
    ...
    /**
     * Supported non-payable function: ERC20.unfreeze
     */
    ...
    /**
     * Supported non-payable function: ERC20.freezeAddress
     */
    ...
    /**
     * Supported non-payable function: ERC20.unfreezeAddress
     */
    ...
    function pause () external
        ...
        onlySealed
    {
        requirement(LABEL_CODE_STAKER_CONTROLLER, WALLET_FLAG_ALL, 1); // 1/ALL signable
    }
    ...
    function setTransactionLimit(string calldata _requirementType, uint256 _limit) external
    {
        if (msg.sender == root || !isSealed) {
            ...
            requirement(LABEL_CODE_STAKER, WALLET_FLAG_ALL, uint8(-1)); // ALL signable
        }
    }
    ...
    function defaultRequirement(string memory _requirementType, uint256 _value) private
    {
        ...
        if (0 < limit.upperLimit) {
            // Truncate timestamp (YYYYMMDD) to daily
        ...
        requirement(LABEL_CODE_OPS, WALLET_FLAG_ALL, 1); // 1/ALL signable
    }

    function allRequirement() private
    {
        requirement(LABEL_CODE_STAKER, WALLET_FLAG_ALL, uint8(-1)); // ALL signable
        requirement(LABEL_CODE_STAKER_CONTROLLER, WALLET_FLAG_ALL, uint8(-1)); // ALL signable
        requirement(LABEL_CODE_SIGNER_CONTROLLER, WALLET_FLAG_ALL, uint8(-1)); // ALL signable
        requirement(LABEL_CODE_SIGNER, WALLET_FLAG_ALL, uint8(-1)); // ALL signable
        requirement(LABEL_CODE_OPS, WALLET_FLAG_ALL, uint8(-1)); // ALL signable
    }

    function requirementAllOps() private
    {
        requirement(LABEL_CODE_STAKER, WALLET_FLAG_ALL, 0); // View only
        requirement(LABEL_CODE_STAKER_CONTROLLER, WALLET_FLAG_ALL, 0); // View only
        requirement(LABEL_CODE_SIGNER_CONTROLLER, WALLET_FLAG_ALL, 0); // View only
        requirement(LABEL_CODE_SIGNER, WALLET_FLAG_ALL, 0); // View only
    ...
    function requirement1Backsys() private
    {
        ...
        requirement(LABEL_CODE_SIGNER_CONTROLLER, WALLET_FLAG_ALL, 0); // View only
        requirement(LABEL_CODE_SIGNER, WALLET_FLAG_ALL, 0); // View only
        requirement(LABEL_CODE_OPS, WALLET_FLAG_ALL, 0); // View only

        requirement(LABEL_CODE_BACKSYS, WALLET_FLAG_ALL, 1); // 1/ALL signable
    }
