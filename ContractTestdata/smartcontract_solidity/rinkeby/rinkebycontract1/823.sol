...
// File: contracts/token/ERC721/ShredNightERC721.sol

contract ShredNightERC721 is ERC721Full, ERC721MetadataMintable {
    constructor() 
        public
        ERC721Full("Shred Night Token", "SHRD")
    {
    }
        function mintFor(address to, string memory _name) public {
            mintWithTokenURI(to, nameToId(_name), _name);
        }
        
        function nameToId(string memory _name) pure public returns (uint256) {
