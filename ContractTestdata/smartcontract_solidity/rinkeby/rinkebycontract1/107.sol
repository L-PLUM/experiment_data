...
contract SAM_v1 is owned {
    ...
    mapping (address => bool) businessesMapping;
    ...
    function addNewBusinessWallet(address _businessAddress) public returns(bool) {
        ...
        require(!businessesMapping[msg.sender], 'Business is already added');
        require(_businessAddress != address(0), 'Invalid business address');
        
        businessesMapping[msg.sender]= true;
        return true;
    }
     ...
     */
    function addNewLicenseData(uint256 saID_, string memory vendorName_, string memory businessName_, address businessWallet_, uint256 licenceIssueDate_, uint256 licenceRenewDate_, string memory status_) public returns(bool){
