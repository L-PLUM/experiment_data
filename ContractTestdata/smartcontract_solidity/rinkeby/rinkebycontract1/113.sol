...
contract EquivalentUSDToken is StandardDelegate, PausableToken, BurnableToken, NoOwner, CanDelegate {
    string public name = "Equivalent USD Token";
    string public symbol = "EQU";
    ...
    function EquivalentUSDToken() public {
        totalSupply_ = 0;
        staker = msg.sender;
    }
