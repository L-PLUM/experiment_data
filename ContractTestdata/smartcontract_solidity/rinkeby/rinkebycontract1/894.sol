...
contract Kit is KitBase {
    ...
    */
    ...
    constructor(DAOFactory daoFactory, ENS ens) KitBase(daoFactory, ens) {
        tokenFactory = new MiniMeTokenFactory();
    }

    function newInstance(address erc20, uint lockAmount, uint256[] lockIntervals, uint256[] tokenIntervals) {
        ...
        tokenLocker.initialize(token, erc20, lockAmount, lockIntervals, tokenIntervals);
