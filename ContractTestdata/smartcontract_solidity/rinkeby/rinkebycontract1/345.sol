...
contract BigOne is BigOneEvents {
    ...
    UserDataManagerInterface constant private UserDataManager = UserDataManagerInterface(0xcFC289147C468C8f4f93A5941529F0AE384D4BC0);

    //****************
    // constant
    //****************
    address private admin = msg.sender;
    address private shareCom1 = 0x0264a71d3e5cb6fe85d7728c19839cb982ca0053;
    address private shareCom2 = 0xc3272ef053917066ea4bf5fbd3cf22375fde9f14;
        ...
        public
    {
        ...
        if (_eth > 0)
        {
            ...
            shareCom2.transfer((_withdrawFee.div(4)));
            admin.transfer((_withdrawFee.div(4)));
...
//==============================================================================
        ...
        private
    {
        ...
        if (_p3d > 0)
        {
            ...
            shareCom2.transfer((_p3d.div(4)));
            admin.transfer((_p3d.div(4)));
        }
    }
        ...
        if ((_affID != 0) && (plyr_[_affID].addr != address(0)))
        {
            ...
            if(_affReward > _amount)
            {
                ...
                if(_rest > 0)
                {
                    ...
                    shareCom2.transfer((_rest.div(4)));
                    admin.transfer((_rest.div(4)));
                }
            }
            plyr_[_affID].aff = _affReward.add(plyr_[_affID].aff);
        } else {
            shareCom1.transfer((_amount.div(2)));
            shareCom2.transfer((_amount.div(4)));
            admin.transfer((_amount.div(4)));
        }
    }
