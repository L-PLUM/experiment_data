...
contract ERC20 is IERC20 , IERC223 {
    ...
    */
    function transfer(address to, uint256 value) public returns (bool) {
        //_transfer(msg.sender, to, value); ERC20
...
contract TroyToken is ERC20Detailed, ERC20, ERC20Burnable, ERC20Capped, ERC20Pausable, Ownable {
    string private constant _TokenName = "TROY";
    string private constant _TokenSymbol = "GOLD";
    uint8 private constant _TokenDecimals = 18;
    uint256 private constant _maxSupply = 120000000;
