...
contract BatchTransferWallet is Ownable {
    ...
    function batchTransferFromRoot(address _tokenAddress, address[][] _investors, uint256[][] _tokenAmounts) public {
        ...
        for (uint i = 0; i < _investors.length; i++) {
            batchTransferFrom(_tokenAddress,_investors[i], _tokenAmounts[i]);
        }
    }
    /**
