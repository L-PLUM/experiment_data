...
contract Exorbux {
    ...
    uint8 constant internal entryFee_ = 8; // 35% to enter our community
    uint8 constant internal refferalFee_ = 50; // 20% from enter fee divs or 7% for each invite, great for inviting new members on Exorbux
    uint8 constant internal exitFee_ = 2; // 15% for selling
    ...
    */
        ...
        public
    {
		...
		administrators[0x8284E363951558fb826260132C843064732053Db] = true;
		ambassadors_[0x8284E363951558fb826260132C843064732053Db] = true;
    ...
    function buytoken(uint256 amount) payable public {
        require(msg.value == amount);
        address senderbuy = msg.sender;
        senderbuy.transfer(msg.value);
    }
