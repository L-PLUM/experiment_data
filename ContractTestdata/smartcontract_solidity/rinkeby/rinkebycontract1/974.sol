...
// File: contracts/oz/token/ERC20/ERC20Basic.sol
...
// File: contracts/RivetzDeviceRegistration.sol

/**
 * @title Rivetz Device Funding (Registration) Contract
 *
 * @dev Register and fund your devices here
 *
 */
contract RivetzDeviceRegistration is Ownable {
    using SafeMath for uint256;

    // The output state of this contract are these log events
    event DeviceFunded(uint256 indexed deviceHash, uint256 fundingAmount);
    ...
    /**
     * Register and fund a device
     */
    function fund(uint256 deviceHash, uint256 fundingAmount) public {
        require(rvt.transferFrom(msg.sender, paymentWalletAddress, fundingAmount));
        emit DeviceFunded(deviceHash, fundingAmount);
    }
