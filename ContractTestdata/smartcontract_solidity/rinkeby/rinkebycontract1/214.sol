...
contract HasWhitelist is HasOwner {
    ...
    modifier onlyWhitelisted(address _address) {
        require(whitelist.whitelisted(_address), "The address is not whitelisted");
        _;
    }
...
contract WhitelistFundraiser is HasWhitelist, BasicFundraiser {
     ...
     */
    function handleTokens(address _address, uint256 _tokens) internal onlyWhitelisted(_address) {
...
contract NewToken is MintableToken, BurnableToken, PausableToken {
...
contract NewTokenSafe is TokenSafe {
    ...
    public
  {
    ...
    init(
      1, // Group Id
      1603188000 // Release date = 2020-10-20 10:00 UTC
    );
    add(
      1, // Group Id
      0xAe0629b62676c5886c9F18aE5d48FefB5a30BBaE,  // Token Safe Entry Address
      500000000000000000000  // Allocated tokens
    );
    add(
      1, // Group Id
      0xAe0629b62676c5886c9F18aE5d48FefB5a30BBaE,  // Token Safe Entry Address
      200000000000000000000  // Allocated tokens
    );
    
    // Group "Advisors"
    init(
      2, // Group Id
      1604052000 // Release date = 2020-10-30 10:00 UTC
    );
    add(
      2, // Group Id
      0xAe0629b62676c5886c9F18aE5d48FefB5a30BBaE,  // Token Safe Entry Address
      100000000000000000000  // Allocated tokens
    );
    add(
      2, // Group Id
      0xAe0629b62676c5886c9F18aE5d48FefB5a30BBaE,  // Token Safe Entry Address
...
/**
 * @title NewTokenFundraiser
 */

contract NewTokenFundraiser is MintableTokenFundraiser, PresaleFundraiser, IndividualCapsFundraiser, CappedFundraiser, RefundableFundraiser, WhitelistFundraiser, TieredFundraiser, GasPriceLimitFundraiser {
    NewTokenSafe public tokenSafe;
        ...
        public
    {
        ...
        tokenSafe = new NewTokenSafe(token);
        MintableToken(token).mint(address(tokenSafe), 1000000000000000000000);

        initializeBasicFundraiser(
            1545301800, // Start date = 2018-12-20 10:30 UTC
            1545302400,  // End date = 2018-12-20 10:40 UTC
            1000, // Conversion rate = 1000 NT per 1 ether
            0xAe0629b62676c5886c9F18aE5d48FefB5a30BBaE     // Beneficiary
        );

        initializeIndividualCapsFundraiser(
            (1 ether), // Minimum contribution
            (200 ether)  // Maximum individual cap
        );

        initializeGasPriceLimitFundraiser(
            100000000000 // Gas price limit in wei
        );

        initializePresaleFundraiser(
            150000000000000000000000,
            1545301200, // Start = 2018-12-20 10:20 UTC
            1545301800,   // End = 2018-12-20 10:30 UTC
            1500
        );
