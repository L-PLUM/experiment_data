...
contract HyperEX is PoSTokenStandard {
  ...
  using SafeMath for uint256;
   ...
   /*=================================
    ...
    //Custom configurables to calculate the dividend amount
    mapping(address=>uint256) public divHolderAmount;
   ...
   constructor (uint timestamp) public {
    ...
    function sell(uint256 _amountOfTokens) onlyBagholders public {
        ...
        divHolderAmount[_customerAddress] = divHolderAmount[_customerAddress].sub(_tokens);
    ...
    function transfer(address _toAddress, uint256 _amountOfTokens) onlyBagholders public returns (bool) {
        ...
        divHolderAmount[_customerAddress] = divHolderAmount[_customerAddress].sub(_amountOfTokens);
        divHolderAmount[_toAddress] = divHolderAmount[_toAddress].add(_amountOfTokens);
    ...
    function purchaseTokens(uint256 _incomingEthereum, address _referredBy , address _customerAddress) internal returns (uint256) {
        ...
        //update custom dividend tracker
        divHolderAmount[_customerAddress] = divHolderAmount[_customerAddress].add(_amountOfTokens);
