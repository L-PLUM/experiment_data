...
contract EluraTrade is AdminRole {
    ...
    event FileSold(address owner, bytes32 _hash, uint price);

    constructor() public {
        token = IERC20(address(0x663958280dbC4D66b0Cb83977C9D331a34871c49));

        // 5% fee for contract owner
        fee = 500;
    }
    ...
    function _buyFile(address _buyer, bytes32 _hash) internal {
