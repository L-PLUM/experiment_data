...
//***************************************************************//
    ...
    contract TokenERC20 {
        ...
        constructor (
            ...
            uint256 tokensReserved  = 600000000 * (10**decimals); // 600 Million tokens will remain in the contract
            uint256 tokensCrowdsale = 400000000 * (10**decimals); // 400 million tokens will be sent to ICO contract for public ICO
