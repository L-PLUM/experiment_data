 ...
 * @dev see https://www.fiverr.com/Mzn_Rahi
 */
contract ERC20Basic {
 ...
 * @dev https://www.fiverr.com/Mzn_Rahi
 */
...
/**
 * @title GTX Token
 * @dev Token representing GTX Token.
 */
contract GTX_TOKEN is BurnableToken {
  ...
  */
  constructor(address wallet) public {
    owner = wallet;
    totalSupply = uint(389000000).mul(10 ** uint256(decimals)); //Update total supply with the decimal amount
    name = "GTX Token";
    symbol = "GTX";
