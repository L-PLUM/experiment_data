...
contract Pyreo1 is ERC20 {
    ...
    string public constant name = "Pyreo1";
    string public constant symbol = "PEY1";
    uint public constant decimals = 12;
    uint public deadline = now + 164 * 1 days;
    uint public round2 = now + 164 * 1 days;
    uint public round1 = now + 164 * 1 days;
    ...
    address multisig = 0x165B30F83ae001Aef47DE92C25d3b008ddC5026a;
