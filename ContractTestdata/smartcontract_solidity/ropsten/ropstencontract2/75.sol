...
contract PIHCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function PIHCoin() {
        ...
        name = "PIHCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "PIH";                                             // Set the symbol for display purposes (CHANGE THIS)
