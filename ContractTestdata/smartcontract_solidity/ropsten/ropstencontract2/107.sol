...
contract CryptoShares {
    ...
    */
    function registerAsShareholderAndSignArbitrationAgreement(
        ...
        // 1
        shareholdersLedgerByIdNumber[id].shareholderID = shareholdersCounter;
        // 2
    ...
    */
    ...
    struct DividendsRound {
        ...
        uint roundFinishedOnUnixTime; //...6
        uint weiForTxFees; //..............7
    }
    ...
    */
    function startDividendsPayments() external returns (bool) {
        ...
        dividendsRound[dividendsRoundsCounter].sumWeiToPayForOneToken = address(this).balance / registeredShares;
        dividendsRound[dividendsRoundsCounter].sumXEurToPayForOneToken = xEuro.balanceOf(address(this)) / registeredShares;
    ...
    function payDividendsToNext() external returns (bool success) {
        ...
        if (balanceOf[to] > 0) {
            ...
            if (sumXEurToPayForOneToken > 0) {
                ...
                uint sumXEuroToPay = sumWeiToPayForOneToken * balanceOf[to];
        ...
        if (feeForTxCaller > 0) {
            // here 'send' instead of 'transfer' is O.K.
            msg.sender.send(feeForTxCaller);
        }
    ...
    */
    ...
    function fundDividendsPayout() external payable returns (bool success){
        ...
        dividendsRound[dividendsRoundsCounter].weiForTxFees = msg.value;
    ...
    * @param _factoryAddress Address of the factory contract that created this cryptoshares contract
