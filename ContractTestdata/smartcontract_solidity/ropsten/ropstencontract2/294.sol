 ...
 */
contract BitAirtToken is ERC721Full, Ownable, Pausable {
  constructor(address payable _feesTo) ERC721Full("BitAirt", "BIT") public {
    pause();
...
contract BitAirtExchange is Ownable {
  ...
  function acceptPhotoAcquisition(uint256 tokenId, address acquirer) public {
    ...
    require(bitAirtToken.ownerOf(tokenId) == msg.sender);
