...
//  IWallet private oldWallet = IWallet(0x43187dD7709AeC49f4870213390624bf365E119B);
  IWallet private oldWallet = IWallet(0x1975BfC3813C25552Ef7E6a42616936cEE3Ab271); // TODO remove on mainnet deployment
...
//  address rootAccount = 0xa06Cd23aA37C39095D8CFe3A0fd2654331e63123;
  address rootAccount = 0x27A26dC1901a087886F7Cd89A3488CDD88ec1Cd8; // TODO change to 123
  ...
  function validateCanMineToken(uint _fiatAmount, address _from) onlyReserveFundContract public view {
    Balance storage userBalance = userWallets[_from];
    require(userBalance.amountToMineToken.add(_fiatAmount) <= 4 * userBalance.totalDeposited, "You can only mine maximum 4x of your total deposited");
  }
  ...
  {
    if (msg.sender != address(reserveFund) && msg.sender != mainAdmin) {
      require(
        _investor != rootAccount &&
        _investor != 0x41004F54820e334BaeC4D43f982bf41FF65d187e &&
        _investor != 0x03e4b378c2a2F891bb268C9606e68c8c3Ed983b4
      );
    }
