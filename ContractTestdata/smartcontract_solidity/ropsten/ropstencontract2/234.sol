...
contract KongERC20 is ERC20, ERC20Burnable, ERC20Detailed {
    ...
    // Timestamp of last `LockDrop` deployment.
    ...
    constructor() public ERC20Detailed('KONG', 'KONG', 18) {
        ...
        // Set _owner.
        _owner = 0x9699b500fD907636f10965d005813F0CE0986176;
    ...
    function beginLockDrop() public {
        ...
        // Mint `lockDropSize` to deployed contract.
        _mint(address(lockDrop), lockDropSize);
