...
/**
 * Source Code first verified at https://etherscan.io on Friday, June 14, 2019
 (UTC) */
...
contract Zembar is Ownable {
  ...
  string public constant symbol = "Zembar";
  string public constant name = "Zembar";
  uint8 public decimals = 8;

  uint256 public totalSupply = 750000000000 * 10 ** uint256(decimals);
