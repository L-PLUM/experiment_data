...
contract _0xSatoshiToken is ERC20Interface, Owned {
    ...
    // the goal is for 0xSatoshi to be mined with 0xBTC
    ...
    function _0xSatoshiToken() public onlyOwner{
        ...
        function merge() public returns (bool success) {
            ...
            // is the sender that has called mint
             ...
             //now that we've checked that the next challenge wasn't reused, apply the current 0xSatoshi challenge 
    ...
    function _reAdjustDifficulty() internal {
        ...
        //we want miners to spend 10 minutes to mine each 'block', about 60 ethereum blocks = one 0xSatoshi epoch = one 0xBitcoin
