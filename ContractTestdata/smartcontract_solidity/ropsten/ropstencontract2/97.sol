...
//  IERC20 public dabToken = IERC20(0x5E7Ebea68ab05198F771d77a875480314f1d0aae); // TODO use this on mainnet deployment
  IERC20 public dabToken = IERC20(0x9D138a5A82f36B3F2c1dE744f2C6bfb08D87a6F9);
  ...
  function updateETHPrice(uint _ethPrice) onlyEthAdmin public {
    if (isEthAdmin()) {
...
//    require(enableJP || msg.sender == 0xa06Cd23aA37C39095D8CFe3A0fd2654331e63123, "Can not buy via Ether now");
    // TODO un comment
    require(enableJP || msg.sender == 0x27A26dC1901a087886F7Cd89A3488CDD88ec1Cd8, "Can not buy via Ether now");
