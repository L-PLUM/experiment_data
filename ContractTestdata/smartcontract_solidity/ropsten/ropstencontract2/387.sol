...
contract SparksterToken is StandardToken, Ownable{
	...
	function purchaseCallbackOnAccept(uint256 groupNumber, address[] memory addresses, uint256[] memory weiAmounts) public onlyOwnerOrOracle returns(bool success) {
	...
	function insertAndApprove(uint256 groupNumber, address[] memory addresses, uint256[] memory weiAmounts) public onlyOwnerOrOracle returns(bool success) {
		uint256 n = addresses.length;
	...
	function callbackInsertApproveAndDistribute(uint256 groupNumber, address[] memory addresses, uint256[] memory weiAmounts) public onlyOwnerOrOracle returns(bool success) {
		uint256 n = addresses.length;
		require(n == weiAmounts.length, "Array lengths mismatch");
		Group storage theGroup = groups[groupNumber];
	...
	function refund(address[] memory addresses, uint256[] memory weiAmounts) public onlyOwnerOrOracle returns(bool success) {
		uint256 n = addresses.length;
		require (n == weiAmounts.length, "Array lengths mismatch");
	...
	function createGroup(string memory groupName, uint256 startEpoch, uint256 phase1endEpoch, uint256 phase2endEpoch, uint256 deadlineEpoch, uint256 phase2weiCap, uint256 phase3weiCap, uint256 hardWeiCap, uint256 ratio) public onlyOwner returns (bool success, uint256 createdGroupNumber) {
	...
	function getGroup(uint256 groupNumber) public view returns(string memory groupName, bool distributed, bool unlocked, uint256 phase2cap, uint256 phase3cap, uint256 cap, uint256 ratio, uint256 startTime, uint256 phase1endTime, uint256 phase2endTime, uint256 deadline, uint256 weiTotal) {
	...
	function airdrop( address[] memory addresses, uint256[] memory tokenDecimalAmounts) public onlyOwnerOrOracle returns (bool success) {
		uint256 n = addresses.length;
