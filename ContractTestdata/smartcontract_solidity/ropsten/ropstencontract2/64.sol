...
CappedCrowdsale, TimedCrowdsale
    {
    uint256 public minCap = 1000000000000000000; //1
    uint256 public maxCap = 455373000000000000000000; //455373 ETH
    ...
    function _preValidatePurchase(address beneficiary, uint256 weiAmount) internal view {
        ...
        require(newContribution >= minCap, "Minimum of 1 ETH per investor");
        require(newContribution <= maxCap,"Max number of token per client reached");
    }
}
