...
contract GoldVlock is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SuperUltraPowerCoin() {
        ...
        name = "GoldVlock";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "GVK";                                             // Set the symbol for display purposes (CHANGE THIS)
