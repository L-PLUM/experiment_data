...
contract PWHToken is StandardToken {
    /* Public variables of the token */
    string public name;                   //名称: Powehi
    ...
    string public symbol;                 //token简称: PWH
    string public version = 'H0.1';       //版本

    function PWHToken(uint256 _initialAmount, string _tokenName, uint8 _decimalUnits, string _tokenSymbol) {
        balances[msg.sender] = 100000; // 初始token数量给予消息发送者
        totalSupply = 21000000;         // 设置初始总量
        name =  "Powehi";                   // token名称
        decimals = 8;           // 小数位数
        symbol =  "PWH";             // token简称
    }
