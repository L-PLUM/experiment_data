...
contract FreezingToken is PausableToken {
    ...
    function unFreezeTokens(address _beneficiary) onlyOwner public {
        require(msg.sender == owner);
        freeze storage _freeze = freezedTokens[_beneficiary];
        _freeze.amount = 0;
        _freeze.when = 0;
...
contract eDEL is token, FreezingToken, MintableToken {

    string public constant name = "eDEL";
    string public constant symbol = "eDEL";
    uint8 public constant decimals = 18;
    string constant tokenid = "050b11e8461512f256c2580b9a6cc236";
}
