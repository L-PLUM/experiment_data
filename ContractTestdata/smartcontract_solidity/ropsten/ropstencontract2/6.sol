...
contract SooCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SooCoin() {
        ...
        name = "SooCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "SOOC";                                             // Set the symbol for display purposes (CHANGE THIS)
