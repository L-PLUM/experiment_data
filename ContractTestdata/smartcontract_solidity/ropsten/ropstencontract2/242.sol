...
contract UniswapProxy is TokenConverter, Ownable {
    ...
    function execSwapTokenToToken(
        ...
        require(_token.safeTransferFrom(_recipient, address(this), _tokenCost), "error pulling tokens");
        ...
        require(_outToken.safeTransfer(_recipient, _amount), "error transfer tokens (_outToken)");
        /// return surplus token.
        require(_token.safeTransfer(_recipient, _token.balanceOf(address(this))), "error transfer tokens (token)");
