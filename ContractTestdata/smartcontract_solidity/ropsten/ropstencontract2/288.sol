...
contract GenieIdentity is Ownable{ 
    ...
    //
    function RegisterIdentifier(string memory _globalIdentifierNumber) public glnHasNotExisted (_globalIdentifierNumber){
        Storage storageSpace = Storage(_storageSpace);
        EntityFactory entityFactory = EntityFactory(storageSpace.getEntityFactoryAddress());
        entityFactory.createEntity(_globalIdentifierNumber);
    }
