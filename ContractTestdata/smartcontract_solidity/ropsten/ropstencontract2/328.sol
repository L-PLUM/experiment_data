...
contract DABANKING_SWAP is Auth {
  ...
  IERC20 private daBanking = IERC20(0x5E7Ebea68ab05198F771d77a875480314f1d0aae);
  IERC20 private daaBounty = IERC20(0x4D566B0b911756C77A327152b862327ff719bFfF);
  uint8 public rate = 100; // 1 DAB = rate * DAA
  ...
  function setTokens(IERC20 _daa, IERC20 _dab) onlyAdmin public {
    daaBounty = _daa;
    daBanking = _dab;
  }
}
