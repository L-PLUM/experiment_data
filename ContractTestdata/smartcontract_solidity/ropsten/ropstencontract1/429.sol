...
contract SineoCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    string public version = 'Sineo1.0'; 
    ...
    function SineoCoin() {
        ...
        name = "SineoCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "sc";                                             // Set the symbol for display purposes (CHANGE THIS)
