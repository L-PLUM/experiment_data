...
contract owned {
    ...
    constructor() public{
        master = 0x645191C89E111cAb9616725F9b91832397140d78; //測試
...
contract external_function{
    ...
    function inquire_domain_building(uint8 _id, uint8 _index) public view returns(uint8);
...
//inquire function
    ...
    function inquire_domain_star(uint8 _id) public view returns(uint8){
    ...
    function inquire_tot_domain_building(uint8 _id) public view returns(uint8[]){
