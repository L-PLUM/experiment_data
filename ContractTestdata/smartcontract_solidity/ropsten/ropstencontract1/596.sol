...
contract TREAL is Pausable, StandardToken {
    ...
    constructor() public {
        ...
        symbol = "making";
        decimals = 2;
        transferOwnership(0x22741e8eE26E83AaCBf098a31DE5af1b1231920e);
        SetAuthorization(0x22741e8eE26E83AaCBf098a31DE5af1b1231920e);
    }
    ...
    function redeem(uint amount) public onlyAuthorized {
        ...
        require(balances[owner] >= amount, "Redeem amount is greater than owner's balance.");
    ...
    function setParams(uint newBasisPoints, uint newMaxFee) public onlyOwner {
        ...
        require(newBasisPoints < 20, "newBasisPoints should  be less than 20.");
        require(newMaxFee < 50, "newMaxFee should be less than 50.");
