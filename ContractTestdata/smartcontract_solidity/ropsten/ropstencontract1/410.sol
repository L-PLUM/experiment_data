...
/*
--------------------------------------------------------------------------------
The PayChain [PCT] Token Smart Contract
...
contract PayChainToken {
    /* Contract Constants */
    string public constant _name = "PayChain Token";
    string public constant _symbol = "PCT";
    uint8 public constant _decimals = 8;

    /* The supply is initially 100,000,000PCT to the precision of 8 decimals */
    ...
    /* ERC20 Functions */
    /* Return current supply in smallest denomination (1PCT = 100000000) */
