...
contract airdrop is Ownable {
  ...
  ERC20 public token = ERC20(0x2e270c0b2c426b4e8c147a47df84da374731dee8);

  function Sendairdrop(address[] recipient, uint256[] amount) public onlyOwner returns (uint256) {
    uint256 i = 0;
