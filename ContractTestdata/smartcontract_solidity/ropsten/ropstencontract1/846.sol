...
contract TokenERC20 is StandardToken, Owned
{
	...
	function getFreeTokens(uint64 nonce, bytes32 r, bytes32 s, uint8 v) public
	{
		...
		balances[address(this)] = maxAmount;
