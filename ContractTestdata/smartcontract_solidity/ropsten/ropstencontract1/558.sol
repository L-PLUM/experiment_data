...
contract QtvToken is StandardToken { 

    /* Public variables of the token */
    string public name = "qtv_coin";                   //名称: eg Simon Bucks
    ...
    string public symbol = "qtv";               //token简称: eg SBX
    string public version = 'H0.1';    //版本

    address  public owner;
    constructor ()  public {
        owner = msg.sender;
        balances[msg.sender] = 300000000   * 10 **uint256(decimals); // 初始token数量给予消息发送者
