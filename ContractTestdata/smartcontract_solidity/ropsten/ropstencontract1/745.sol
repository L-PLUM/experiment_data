...
contract CardRPS {
    ...
    function settleBetCommon(Bet storage bet, uint reveal, bytes32 entropyBlockHash) private {
        ...
        uint seed = uint(keccak256(abi.encodePacked(reveal, entropyBlockHash)));
        ...
        randomNumber.rouletteIndex = uint8(seed % 3);
        seed = seed / 2 ** 8;
        ...
        handleJackpotStatus(bet, amount, randomNumber, seed, vipLib);
