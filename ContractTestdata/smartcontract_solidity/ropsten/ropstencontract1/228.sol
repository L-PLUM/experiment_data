...
contract MiningToken is ERC20Detailed, ERC20Capped{
  ...
  uint256 public totalRewardAddress = 5;
  uint256 public perAddressToken = 100000 * (10 ** uint256(DECIMALS));
  uint256 public minimumBlocks = 10;

  mapping (address => uint256) private _balances;
  address[] _rewardAddress = [
    0x834B622e73aa6aD6ad2c8A1834282176484547EB,
  ...
  constructor () public ERC20Detailed("UMining Token", "UMT", DECIMALS) ERC20Capped(TOTAL_SUPPLY) {
