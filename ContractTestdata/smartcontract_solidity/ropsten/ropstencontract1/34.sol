...
interface ERC721_interface{
 ...
 contract master is owned {
    ...
    mapping (uint8 => string) public area; //建造建築物的價格 
    ...
    mapping (uint8 => uint) public building_price; //建造建築物的價格
     ...
     constructor() public{
        ...
        //(現代科技土地類):
        building_type[11] = "Fuel station" ; //燃料站
        building_type[12] = "Research Lab" ; //研究所
        building_type[13] = "Racecourse" ; //競馬場
        building_type[14] = "Airport" ; //機場
        building_type[15] = "Bank" ; //銀行
        building_type[16] = "Department store" ; //百貨公司
        building_type[17] = "Station" ;//車站
        building_type[18] = "Hotel" ; //飯店
        building_type[19] = "Shop" ; //商店
        building_type[20] = "Weapon factory" ; //兵工廠
        ...
        building_price[14] = 10000*10**8 ; 
        building_price[15] = 5000*10**8 ; 
...
////inquire function
    ...
    function inquire_city_area(uint8 _city) public view returns(uint8){
        address city_address = owner_slave[_city];
        return slave(city_address).area_number();
    }
