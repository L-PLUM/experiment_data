...
contract PagoNomina {
    ...
    function PagarNomina() public {
        ...
        //la funcion fallback consume mucha gasolina
        //si el contrato se queda sin ether
        //ya no puede recibir mas dinero
        uint C = TotalFacturado - G;
