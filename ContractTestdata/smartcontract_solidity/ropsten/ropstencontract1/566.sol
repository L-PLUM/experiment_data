...
contract WhiteList is Ownable {
    ...
    modifier isAvailableTokenBalance(address tokenAddress, uint tokenAmount) {
    ...
    constructor (address _BLAddr) isContract(_BLAddr) public{
        BLAddress = _BLAddr;
    } 
    ...
    function getBLAddress() public view returns(address){
        return BLAddress;
    }
    ...
    function getCustomer(address _customerAddress) public view isCustomerAdded(_customerAddress) returns (bool, address, address){
        Customer memory c = customers[_customerAddress];
        return (c.isReqACC, c.KYCAddr, c.ACCAddr);
    }
    ...
    function checkCustomer(address _address) public isCustomerAdded(_address) returns(bool){
