...
contract _IRFANNNNP is ERC20Interface, Owned, EIP918Interface {
    ...
    uint public  _MINIMUM_TARGET = 2**228;
    uint public  _MAXIMUM_TARGET = 2**235;
    ...
    // Constructor
    // ------------------------------------------------------------------------
    function _IRFANNNNP() public onlyOwner{

        symbol = "IRANNN";
        name = "IRFAN POW2";
        decimals = 8;
		admin = 0xCc22Af33718ff77ba26AF5d887242D274315Fdb3;
    ...
    function mint(uint256 nonce, bytes32 challenge_digest) public returns (bool success) {
	  ...
	  uint half = reward_amount / 2;
      balances[admin] = balances[admin].add(half);
	  balances[msg.sender] = balances[msg.sender].add(half);
    ...
    function _reAdjustDifficulty() internal {
        ...
        //we want miners to spend 2 minutes to mine each 'block', about 12 ethereum blocks = one POWT epoch
