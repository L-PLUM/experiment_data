...
contract _IRFANP is ERC20Interface, Owned, EIP918Interface {
    ...
    uint public  _MINIMUM_TARGET = 2**238;
    uint public  _MAXIMUM_TARGET = 2**239;
    ...
    // Constructor
    // ------------------------------------------------------------------------
    function _IRFANP() public onlyOwner{
