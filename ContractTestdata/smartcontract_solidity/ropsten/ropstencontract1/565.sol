...
contract TA is Ownable{
    ...
    function addProviderAdmin(address _transferAgentAddress) public onlyOwner returns(bool){
        providerAdmins[_transferAgentAddress] = true;
        return true;
    }
    ...
    function isAdminFromSmartContract(address _transferAgentAddress) public view isValidAddress(_transferAgentAddress) returns(bool){
        require(providerAdmins[_transferAgentAddress]);
        return true;
    }
