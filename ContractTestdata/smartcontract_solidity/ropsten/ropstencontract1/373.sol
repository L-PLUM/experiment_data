...
contract EtherDelta is SafeMath {
  ...
  event Trade(address tokenGet, uint amountGet, address tokenGive, uint amountGive, address get, address give,string orderId);
  ...
  function trade(address tokenGet, uint amountGet, address tokenGive, uint amountGive, uint expires, uint nonce, address user, 
    ...
    emit Trade(tokenGet, amount, tokenGive, amountGive * amount / amountGet, user, msg.sender,orderId);
    // anjali
  }
