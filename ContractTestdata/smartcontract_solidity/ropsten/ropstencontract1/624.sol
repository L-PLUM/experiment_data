...
contract SM is SafeMath{
    ...
    /*  
      ...
      function transfer(address _to, uint256 _val) public returns(bool){
           ...
           balanceOf[msg.sender] = SafeMath.safeSub(balanceOf[msg.sender] , _val);
           balanceOf[_to] = SafeMath.safeAdd(balanceOf[_to], _val);
      ...
      function transferFrom(address _from, address _to, uint256 _val)public returns(bool){
          ...
          balanceOf[_from] = SafeMath.safeSub(balanceOf[_from], _val);
          balanceOf[_to] = SafeMath.safeAdd(balanceOf[_to], _val);
          allowance[_from][msg.sender] =SafeMath.safeSub(allowance[_from][msg.sender], _val);
      ...
      function burn(uint256 _val) public returns(bool){
          ...
          balanceOf[msg.sender] = SafeMath.safeSub(balanceOf[msg.sender], _val);
          totalSupply = SafeMath.safeSub(totalSupply, _val);
     ...
     function unfreeze(uint256 _val)public returns(bool){
         ...
         freezeOf[msg.sender] = SafeMath.safeSub(freezeOf[msg.sender], _val);
