...
contract LatteReum is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function LatteReum() {
        ...
        name = "LatteReum";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "LTR";                                             // Set the symbol for display purposes (CHANGE THIS)
