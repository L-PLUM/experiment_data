...
contract Token {
    address internal _amo; //de momento es un contrato centralizado
    //en un futuro contrato esta condición es rediseñada mediante VOTO de miembros
    ...
    mapping (address => bool) internal _apoderaDos;
...
contract ACRES is Token("ACR", "Participaciones Fiduciarias", 18, 1), ERC20, ERC223 {
    ...
    function Poderes(address _addr) Autorizado public constant returns (bool) {
        return _apoderaDos[_addr];
    }
}
