...
contract PagarLaNomina {
    ...
    constructor () payable {
        ...
        Jefe = msg.sender;
        //en un principio la bandera debe ir en alto
        //para evitar que se realice un pago de nomina 
        //cuando nadie aun ha trabajado
        Bandera = true;
        Penalty = false;
        Referencia = now;
        Semana[4] = "lunes"; //4
        Semana[5] = "martes"; //5
        Semana[6] = "miercoles"; //6
        Semana[0] = "jueves"; //0
        Semana[1] = "viernes"; //1
        Semana[2] = "sabado"; //2
        Semana[3] = "domingo"; //3
