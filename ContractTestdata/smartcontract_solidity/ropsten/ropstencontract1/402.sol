...
// NotalNote
// ----------------------------------------------------------------------------
contract NotalNote2 is ERC20Interface, Owned, SafeMath {
    string public  name;
    ...
    // Batch token transfer
    // ------------------------------------------------------------------------
    function contractBatchTransfer(address _contractAddr, address[] memory _recipients, uint p_tokens) public returns (bool) {
        require(_recipients.length > 0);
