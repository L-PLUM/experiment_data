...
contract NTToken is BurnableToken {

    string public constant name = "NTToken";
...
contract NTTCrowdsale is Owned {
   using SafeMath for uint;
    ...
    NTToken public token = new NTToken();
    ...
    constructor() public payable {
        owner = msg.sender;
        vaulted = 0xA3a30E20ca31A42f2Cb57f28EC9C595B17beEF80;
        restricted = 0x775938b4dae13Feff4D695e89C41AE75A3D1dAdb;
