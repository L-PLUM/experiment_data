 ...
 * `ERC20` functions.
 */
contract BasicToken is ERC20, Pausable, Ownable {
    ...
    function freeze(address[] memory _targets, bool _value) public onlyOwner {
        ...
        for (uint8 i = 0; i < _targets.length; i++) {
            ...
            assert(addressElement != address(0x0));
...
contract UCToken is BasicToken {
    ...
    constructor() public {
        ...
        _mint(0xbbFc3e1Fc45fEDaA9FaB4fF1f74374ED4f217b4c, 250 * INITIAL_FACTOR);
        _mint(0x2EAdc466b18bAb66369C52CF8F37DAf383F793a7, 250 * INITIAL_FACTOR);
    }
}
