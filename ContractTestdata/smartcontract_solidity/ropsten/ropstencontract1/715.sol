...
contract ERC20AdminDebt is IERC20, AdminRole {
    ...
    string private _fundingStartDate;
    string private _fundingEndDate;
    ...
    constructor (
        ...
        uint32 interestBPS,
        string memory fundingStartDate,
        string memory fundingEndDate,
        string memory expiryDate) public {
        ...
        _fundingStartDate = fundingStartDate;
        _fundingEndDate = fundingEndDate;
    ...
    */
    ...
    /**
     * @return the funding start date
     */
    function fundingStartDate() public view returns (string memory) {
        return _fundingStartDate;
    }

    /**
     * @return the funding end date
     */
    function fundingEndDate() public view returns (string memory) {
        return _fundingEndDate;
    }
