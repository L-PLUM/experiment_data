...
contract PantsToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function PantsToken() {
        ...
        name = "PantsToken";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "PANTS";                                             // Set the symbol for display purposes (CHANGE THIS)
