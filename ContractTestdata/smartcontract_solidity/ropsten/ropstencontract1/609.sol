...
contract HbeCrowdsale is CanReclaimToken, CappedCrowdsale, MintedCrowdsale, WhitelistedCrowdsale, FinalizableCrowdsale, Pausable {
    ...
    address public constant ETH_WALLET = 0x11FCD9cE3763Bd38ed9cEC5318162C45cF4C3333;    // TODO: update wallet
    address public constant TEAM_WALLET = 0xCCb50efc315614dF57f2C774391A3410B02F06EF;   // TODO: update wallet
    uint256 public constant START_EASTER_BONUS = 1577232000; // Wed December 25, 19 12:00 AM //TODO: Update Timestamp
    uint256 public constant END_EASTER_BONUS = 1577404799;   // Thurs December 26, 19 11:59 PM //TODO: Update Timestamp
    /*** CONSTANTS ***/
    uint256 public constant ICO_HARD_CAP = 4e9;             //   4,000,000,000 tokens, 0 decimals spec v1.7
    ...
    uint256 public constant BONUS_2 = 10;   // set 2 and Easter Bonus (25&26 of Dec) - 10% bonus
    ...
    constructor(
        ...
        CappedCrowdsale(ICO_HARD_CAP) {    
            ...
            // calculate the HBE/ETH rate
            rate = (_rate.mul(1e4).div(CHF_HBE_RATE));
        }
    ...
    */
     ...
     */
    function refundLeftOverWei(uint256 _weiReceived, uint256 _tokenAmount) internal returns (uint256) {
        uint256 refundAmount = 0;
        uint256 weiInvested = _tokenAmount.mul(1e18).div(rate);
