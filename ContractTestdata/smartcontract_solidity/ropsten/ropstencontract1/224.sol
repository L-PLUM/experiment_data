...
contract AuthToken is ERC721Full("AuthToken", "AT"), Ownable {
    ...
    function mint(
        ...
        uint id = authTokens.push(delegateID) - 1;
    ...
    function getTokenDelegate(uint id) public view returns (Delegate) {
        address d = delegates[authTokens[id]];
    ...
    string public constant tokenMetadataBaseURI = "https://api.authToken/";
    ...
    function getAuthTokenByTokenId(uint256 tokenId) public view returns (
        ...
        Delegate delegate = getTokenDelegate(tokenId);
        return delegate.getAuthTokenByTokenId(tokenId);
    }
}
