...
contract MoogToken is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function MoogToken() {
        ...
        name = "Moog Token";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "MOOG";                                             // Set the symbol for display purposes (CHANGE THIS)
