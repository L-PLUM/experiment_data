...
contract SessionRecord is Ownable {
  ...
  function getAttendeeDetail(string memory _session, string memory _email) public view returns (string memory, string memory, string memory, uint256) {
    Attendance memory a = sessions[_session][_email];
    return (a.firstName, a.lastName, a.phone, a.timestamp);
  }
  ...
  function getFirstName(string memory _session, string memory _email) public view returns (string memory) {
    return sessions[_session][_email].firstName;
  }
  ...
  function getLastName(string memory _session, string memory _email) public view returns (string memory) {
    return sessions[_session][_email].lastName;
  }
  ...
  function getPhone(string memory _session, string memory _email) public view returns (string memory) {
    return sessions[_session][_email].phone;
  }
