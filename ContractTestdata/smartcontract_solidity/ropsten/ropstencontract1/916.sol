...
contract examplelalala is StandardToken, Owned {
    string public constant name = "examplelalala";
    string public constant symbol = "LALALALA";
    ...
    /// HOT sale start time
    uint64 private constant dateHOTSale = 1549947600 + 1 hours;

    /// HOT sale end time; Sale A start time 07.02.2019
    uint64 private constant dateSaleA = 1549951200 + 1 hours;

    /// Sale A end time; Sale B start time 14.02.2019
    uint64 private constant dateSaleB = 1549954800+ 1 hours;

    /// Sale B end time; Sale C start time 21.02.2019
    uint64 private constant dateSaleC = 1549958400 + 1 hours;
