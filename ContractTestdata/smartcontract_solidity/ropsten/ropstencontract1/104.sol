...
contract _IRFANPOW is ERC20Interface, Owned, EIP918Interface {
    ...
    uint public  _MINIMUM_TARGET = 2**244;
    uint public  _MAXIMUM_TARGET = 2**245;
    ...
    // Constructor
    // ------------------------------------------------------------------------
    function _IRFANPOW() public onlyOwner{
