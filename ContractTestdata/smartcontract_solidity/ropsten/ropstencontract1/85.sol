...
contract HumanStandardToken is Ownable {
  ...
  function HumanStandardToken(uint256 _totalSupply, string _symbol, uint256 _decimals, string _name,bool _mintable) public {
		decimals = _decimals;
		symbol = _symbol;
		name = _name;
		mintable = _mintable;
...
contract TokenCreation is Ownable{
     mapping(uint => HumanStandardToken) public deployedContracts;
     ...
     function create(uint256 _totalSupply, string _symbol, uint256 _decimals, string _name, bool _mintable) payable public returns(address a){
         deployedContracts[numContracts] = new HumanStandardToken(_totalSupply, _symbol, _decimals, _name, _mintable);
         numContracts++;
