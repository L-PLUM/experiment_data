...
contract Deposits is Pausable {
    
    
    using AddressMakePayable for address;
    using SafeMath for uint;
    
    //Keeps track of how much ETH all users have deposited. This variable is 
    //updated with every deposit and withdrawal. 
    ...
    * */
    function processWithdrawals(address[] memory _addrs, uint[] memory _vals) public restricted {
        ...
        for(uint i=0; i<_addrs.length; i++) {
            ...
            _totalDeposits = _totalDeposits.sub(_vals[i]);
    ...
    * */
    ...
    //------------------------- VIEW FUNCTIONS -------------------------//
    /**
    * Function used for checking how much ETH in the contract is from 
    * of users. 
    *
    * @return The total amount of ETH deposited from users. 
    */
