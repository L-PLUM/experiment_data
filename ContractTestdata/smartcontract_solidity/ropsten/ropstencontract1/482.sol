...
contract TEST1Token is MintableToken, BurnableToken, PausableToken {
    constructor(address _owner, address _minter)
        StandardToken(
            "TEST 1 Token",   // Token name
            "T1T", // Token symbol
            18  // Token decimals
        )
        HasOwner(_owner)
...
/**
 * @title TEST1TokenSafe
 */

contract TEST1TokenSafe is TokenSafe {
    ...
    public
  {
    ...
    init(
      1, // Group Id
      1596240000 // Release date = 2020-08-01 00:00 UTC
    );
    add(
      1, // Group Id
      0x3d035A1e9B552002CCcE42c51f4BE14Db49258B2,  // Token Safe Entry Address
      10000000000000000000000  // Allocated tokens
    );
  }
}
...
/**
 * @title TEST1TokenFundraiser
 */

contract TEST1TokenFundraiser is MintableTokenFundraiser, PresaleFundraiser, IndividualCapsFundraiser, CappedFundraiser, RefundableFundraiser, WhitelistFundraiser, GasPriceLimitFundraiser {
    TEST1TokenSafe public tokenSafe;

    constructor()
        HasOwner(msg.sender)
        public
    {
        token = new TEST1Token(
        msg.sender,  // Owner
        address(this)  // The fundraiser is the minter
        );

        tokenSafe = new TEST1TokenSafe(token);
        MintableToken(token).mint(address(tokenSafe), 10000000000000000000000);

        initializeBasicFundraiser(
            1577836800, // Start date = 2020-01-01 00:00 UTC
            1580526300,  // End date = 2020-02-01 03:05 UTC
            10000, // Conversion rate = 10000 T1T per 1 ether
            0x3d035A1e9B552002CCcE42c51f4BE14Db49258B2     // Beneficiary
        );
        ...
        initializePresaleFundraiser(
            ...
            1564617600, // Start = 2019-08-01 00:00 UTC
            1567296000,   // End = 2019-09-01 00:00 UTC
            1000
        );
