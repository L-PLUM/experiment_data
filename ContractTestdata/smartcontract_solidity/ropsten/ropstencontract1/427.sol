...
contract HashnodeTestCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function HashnodeTestCoin() {
        balances[msg.sender] = 1000000000000000000000000000;         //1M  // Give the creator all initial tokens. This is set to 1000000000 for example. If you want your initial tokens to be X and your decimal is 5, set this value to X * 100000. (CHANGE THIS)
        ...
        symbol = "TKO";                                             // Set the symbol for display purposes (CHANGE THIS)
