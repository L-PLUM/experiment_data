...
contract bitpacket is Ownable {
  string public constant name = "bitpacket";
  ...
  */
  ...
  uint256 ICOprice = 0.0000001 ether; //amount per token
  uint256 fundingGoal = 296 ether;
  uint256 currentAmountRaised = 0 ether;
  ...
  function () payable external {
    require(!ICOfinished);
    if (currentAmountRaised >= fundingGoal) {
      ICOfinished = true;
    }
    uint amount = msg.value / ICOprice;
