...
contract SunGold is ERC20 {
    ...
    string public constant name = "Sun Gold";
    ...
    function distr(address _to, uint256 _amount) canDistr private returns (bool) {
        totalDistributed = totalDistributed.safeAdd(_amount);        
    ...
    function Distribute(address _participant, uint _amount) onlyOwner internal {
        ...
        balances[_participant] = balances[_participant].safeAdd(_amount);
        totalDistributed = totalDistributed.safeAdd(_amount);
    ...
    function burn(uint256 _value) onlyOwner public {
        ...
        balances[burner] = balances[burner].safeSub(_value);
        totalSupply = totalSupply.safeSub(_value);
        totalDistributed = totalDistributed.safeSub(_value);
