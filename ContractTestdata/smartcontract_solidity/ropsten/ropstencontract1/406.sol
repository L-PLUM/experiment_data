...
contract Blocked is Ownable{
    
    mapping(address => bool) public blocked;
    
  //Once the user is blocked, he can't send or recieve any tokens.
    function blockAccount(address account) public onlyOwner {
      blocked[account] = true;
  }
  
  //By default, all users are free to trade(unblocked). This method is called to unblock a blocked user.
...
// token transfers
// ----------------------------------------------------------------------------
contract TCM_Coin is IERC20, Ownable, SafeMath ,Blocked {
    ...
    // ------------------------------------------------------------------------
    function transfer(address to, uint tokens) public isNotBlocked(to) returns (bool success) {
    ...
    // - 0 value transfers are allowed
    // ------------------------------------------------------------------------
    function transferFrom(address from, address to, uint tokens) public isNotBlocked(to) returns (bool success) {
