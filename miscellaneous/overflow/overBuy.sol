...
/// Functions:
    ...
    function buyTokensICO() public payable onlyInState(State.ICORunning)
    {
        ...
        require(newTokens <= totalSoldTokens + newTokens  );
		require(totalSoldTokens + newTokens >= newTokens );
